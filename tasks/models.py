...
class Task(models.Model):
    ...
    image = models.ImageField(null=True, verbose_name='Изображение', blank=True, upload_to='tasks/')
    time_created = models.DateTimeField(auto_now_add=True, auto_created=True, verbose_name="Время создания")
